...
| INEGI BIE | Banco de Información Económica: series económicas (INPC, PIB, IGAE, comercio exterior, coyuntura) por área geográfica con su árbol temático (en carga) | `/api/v1/bie/*` |
...
| Cubos | La capa que consume el explorador del observatorio (datosmexico.org/observatorio): 35 cubos con medidas y dimensiones sobre ANUIES, ENOE, CONSAR, Censo 2020, registros vitales (defunciones 1990-2024 y nacimientos 1985-2024), DENUE, ENIGH, percepción de inseguridad (ENVIPE y ENSU), CDMX, UNAM y el Banco de Indicadores del INEGI; consulta agregada con filtros, jerarquías y descarga JSON/CSV desde una URL que reproduce cada tabla | `/api/v1/cubos/*` |
