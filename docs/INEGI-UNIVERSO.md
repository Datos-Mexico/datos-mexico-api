...
| DENUE | Directorio de todas las unidades económicas activas (edición 05/2026) | EN CURSO | 32 estados, 42 campos; `/api/v1/denue/resumen` |
...
| Censo de Población y Vivienda 2020 | Resultados por localidad (ITER), por AGEB y manzana, y microdatos de la muestra | PENDIENTE | — |
