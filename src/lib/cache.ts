...
function valor(path: string): string | null {
  ...
  if (path.startsWith("/api/v1/enigh") || path.startsWith("/api/v1/comparativo") || path.startsWith("/api/v1/consar") || path.startsWith("/api/v1/enoe") || path.startsWith("/api/v1/inegi") || path.startsWith("/api/v1/bie") || path.startsWith("/api/v1/denue") || path.startsWith("/api/v1/censo2020") || path.startsWith("/api/v1/anuies") || path.startsWith("/api/v1/unam") || path.startsWith("/api/v1/cubos")) return "public, max-age=3600";
