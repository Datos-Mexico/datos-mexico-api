...
import { CONSAR_ACTIVO, CONSAR_COMISIONES, CONSAR_CUENTAS, CONSAR_FLUJOS, CONSAR_RECURSOS, CONSAR_RENDIMIENTOS, CONSAR_TRASPASOS } from "./consar";
...
export const CUBOS: Cubo[] = [
  ...
  CONSAR_RECURSOS, CONSAR_COMISIONES, CONSAR_CUENTAS, CONSAR_ACTIVO, CONSAR_RENDIMIENTOS, CONSAR_TRASPASOS, CONSAR_FLUJOS,
  CENSO_ITER, CDMX_NOMBRAMIENTOS, UNAM_CONCURSO,
];
