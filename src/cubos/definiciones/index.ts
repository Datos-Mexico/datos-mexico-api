...
export const TEMAS: Tema[] = [
  ...
  { clave: "poblacion", nombre: "Población", descripcion: "Censo de Población y Vivienda 2020 (INEGI) por localidad, municipio y entidad; tabulados de los censos 2000, 2010 y 2020, el Conteo 2005 y la Encuesta Intercensal 2015; nacimientos registrados 1985-2024 y defunciones registradas 1990-2024 por municipio, causa y edad." },
...
export const CUBOS: Cubo[] = [
  ...
  CENSO_ITER, CENSO_CARACTERISTICAS, CENSO_HOGARES, TABULADOS[0], TABULADOS[1], TABULADOS[2], TABULADOS[3], TABULADOS[4], TABULADOS[5], TABULADOS[6], NAC_MUNICIPIO, NAC_MADRE, DEF_MUNICIPIO, DEF_CAUSA, DEF_LISTA, ENADID_MUJERES, DENUE_UNIDADES, DENUE_HISTORICO, DENUE_HISTORICO_MUNICIPAL, SAIC_CENSOS, ENIGH_HOGARES, ENIGH_PERSONAS, ENIGH_VIVIENDAS, ENIGH_GASTOS, ENIGH_INGRESOS, ENVIPE_PREVALENCIA, ENVIPE_PERCEPCION, ENSU_PERCEPCION, ENDIREH_VIOLENCIA, ENSANUT_IMC, ENDUTIH_USUARIOS, TABULADOS[7], TABULADOS[8], CDMX_NOMBRAMIENTOS, UNAM_CONCURSO, BISE_INDICADORES, BIE_SERIES,
];
