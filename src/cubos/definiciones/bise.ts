...
export const BISE_INDICADORES: Cubo = {
  ...
  dimensiones: [
    { clave: "indicador", titulo: "Indicador", id: "o.indicador", nombre: NOMBRE_INDICADOR, tipo: "categorica", descripcion: "Nombre del INEGI, ruta temática del Banco de Indicadores (tema › subtema › …), posición dentro del tema hoja y unidad. Búsqueda por cualquier parte del nombre en /miembros?dimension=indicador&q=…", miembros: { desde: "indicadores i LEFT JOIN temas t ON t.clave = i.tema LEFT JOIN unidades u ON u.clave = i.unidad", id: "i.id", nombre: NOMBRE_INDICADOR, donde: "i.con_datos = 1", orden: "i.n_observaciones DESC", buscar: "i.busqueda" } },
