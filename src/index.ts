...
import { SaicActividades, SaicDatos, SaicDescarga, SaicResumen, SaicVariables } from "./inegi/saic";
import { TabuladosArchivo, TabuladosCuadro, TabuladosCuadros, TabuladosFamilias } from "./inegi/tabulados";
...
openapi.get("/api/v1/inegi/tabulados", TabuladosFamilias);
openapi.get("/api/v1/inegi/tabulados/:familia", TabuladosCuadros);
openapi.get("/api/v1/inegi/tabulados/:familia/:cuadro", TabuladosCuadro);
openapi.get("/api/v1/inegi/tabulados/:familia/:cuadro/archivo", TabuladosArchivo);
openapi.get("/api/v1/inegi/saic", SaicResumen);
openapi.get("/api/v1/inegi/saic/variables", SaicVariables);
openapi.get("/api/v1/inegi/saic/actividades", SaicActividades);
openapi.get("/api/v1/inegi/saic/datos", SaicDatos);
openapi.get("/api/v1/inegi/saic/descarga/:anio", SaicDescarga);
